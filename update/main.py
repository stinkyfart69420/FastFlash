...
def select_linux_distro():
    ...
    if choice == '1':
        ...
        distros = {
            ...
            '12': 'https://download.fedoraproject.org/pub/fedora/linux/releases/test/40_Beta/Workstation/x86_64/iso/Fedora-Workstation-Live-x86_64-40_Beta-1.10.iso'
        }
